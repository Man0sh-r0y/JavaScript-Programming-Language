...
let promiseAny = Promise.any([p1, p3]);
...
// If one of the promises in the iterable object is fulfilled (resolve or rejects),
...
//     [errors]: [ 'Promise 4 rejected', 'Promise 5 rejected', 'Promise 6 rejected' ]
//   }